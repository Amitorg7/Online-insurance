				...
				<table class="table table-bordered" id="loan-list">
					...
					<thead>
						<tr>
							...
							<th class="text-center">Insurance Details</th>
						...
						<?php
						 ...
						 <tr>
						 	...
						 	<td>
						 		...
						 		<p><small>Insurance type :<b><?php echo $type_arr[$row['loan_type_id']] ?></small></b></p>
						 	...
						 	<td>
						 		...
						 		<p><small>Service Charge :<b><?php echo $add = (date('Ymd',strtotime($next)) < date("Ymd") ) ?  $penalty : 0; ?></b></small></p>
